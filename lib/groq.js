...
// Siza NEVER states a price unless it comes from the knowledge base.
function buildSizaSystemPrompt(event, channel) {
  ...
  const tone = isFestival
    ? 'You are Siza, an upbeat and friendly assistant. Keep it fun and energetic but still helpful.'
    : isCorporate
    ? 'You are Siza, a professional and courteous assistant. Be concise, clear, and formal.'
    : 'You are Siza, a warm and helpful assistant.';
...
module.exports = { groqChat, groqEmbed, buildSizaSystemPrompt };
