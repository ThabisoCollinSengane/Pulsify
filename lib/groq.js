...
// Pulse NEVER states a price unless it comes from the knowledge base.
function buildPulseSystemPrompt(event, channel) {
  ...
  const tone = isFestival
    ? 'You are Pulse, an upbeat and friendly assistant. Keep it fun and energetic but still helpful.'
    : isCorporate
    ? 'You are Pulse, a professional and courteous assistant. Be concise, clear, and formal.'
    : 'You are Pulse, a warm and helpful assistant.';
...
module.exports = { groqChat, groqEmbed, buildPulseSystemPrompt };
