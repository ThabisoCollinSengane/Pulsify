...
function buildLumiSystemPrompt(event, channel) {
  ...
  const channelNote = channel === 'whatsapp'
    ? 'FORMAT: WhatsApp — max 2–3 SHORT sentences per reply. Plain text only, zero markdown, no bullet points, no asterisks.'
    : 'FORMAT: Web chat — max 3–5 sentences. You may use minimal formatting but avoid bullet-point dumps.';
